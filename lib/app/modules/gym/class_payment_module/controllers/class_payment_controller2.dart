...
class ClassPaymentController2 extends GetxController {
  static ClassPaymentController2 get to => Get.find();
                ...
                GestureDetector(
                  onTap: () {
                    DatePicker.showDateTimePicker(Get.context!,
                      ...
                      ClassPaymentController2.to.deliveryDate = date;
                        ...
                        () => ClassPaymentController2.to.deliveryDate != null
                            ? DefaultText(
                                DateFormat('yyyy-MM-dd HH:mm').format(
                                    ClassPaymentController2.to.deliveryDate!),
                    ...
                    IsApprovedMutation(
                      ...
                      builder: (runMutation, result) {
                        return RoundedLoadingButton(
                          ...
                          elevation: 0,
                          onPressed: () {
                            if (ClassPaymentController2.to.deliveryDate ==
                                null) {
                            ...
                            runMutation({
                              'classPaymentMasterIds': ClassPaymentController2
                                  .to.selectedUnapprovedPayments,
                              'date': ClassPaymentController2.to.deliveryDate
                                  ?.toIso8601String()
                            });
                          },
                          controller: ClassPaymentController2
